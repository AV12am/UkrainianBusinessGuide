...
struct DeclarationView: View {
    ...
    private func thirdGroup(_ profile: BusinessProfile) -> some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text("У декларації 3 групи дохід вказують наростаючим підсумком з початку року, а податки — за звітний квартал. Подати треба протягом 40 днів після кінця кварталу в Електронному кабінеті, сплатити — протягом 50 днів.")
                .font(.subheadline)
                .foregroundStyle(Theme.inkMuted)
    ...
    private func fixedGroup(_ profile: BusinessProfile) -> some View {
        ...
        return VStack(alignment: .leading, spacing: 14) {
            ...
            Text("Декларацію 1–2 груп подають раз на рік, протягом 60 днів після його завершення. Єдиний податок і військовий збір сплачують щомісяця фіксованою сумою, тому в декларації головне — сума доходу.")
                .font(.subheadline)
                .foregroundStyle(Theme.inkMuted)
                .fixedSize(horizontal: false, vertical: true)
        }
